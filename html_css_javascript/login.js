...
document.getElementById('auth-form').addEventListener('submit', function(e) {
    ...
    // Retrieve user's email from the input field
    ...
    fetch(`https://api.github.com/users/${email}/repos`)
      ...
      .then(data => {
        if (typeof data === 'object' && data !== null && data.message === "Not Found") {
            alert("Github username or email not found. Please provide a valid github username")
          }else{
